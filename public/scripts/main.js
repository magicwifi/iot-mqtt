...
function addAxis(name, color) {
  ...
  $("#legend-list").append('<li><span class="legend-box" style="background:'+color.fill+'; border:'+color.stroke+' 1px solid;"></span> '+name+' </li>');
}
...
function createTimeSeriesGraph(sensor) {
    ...
    var wsbroker = "42.123.86.187";  //mqtt websocket enabled broker
    ...
    client.onMessageArrived = function (message) {
      ...
      update(obj.coordinates);
    };
    var options = {
      timeout: 3,
      onSuccess: function () {
        console.log("mqtt connected");
        client.subscribe('leapmotion', {qos: 0});
      },
